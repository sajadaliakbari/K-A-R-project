...
<div class="border-radius-xl mt-4 mx-4 position-relative" style="background-image: url('/master/assets/img/vr-bg.jpg') ; background-size: cover;">
...
<div class="container">
    ...
    <div class="col-lg-1 col-md-1 pt-5 pt-lg-0 ms-lg-5 text-center">
        ...
        <img class="border-radius-lg" alt="Image placeholder" src="/master/assets/img/team-1.jpg">
        </a>
    ...
    <div class="col-lg-8 col-md-11">
        ...
        <div class="ms-auto">
            <img class="w-50 float-end mt-md-n5" src="/master/assets/img/small-logos/icon-sun-cloud.png" alt="image sun">
        </div>
        </div>
        <div class="row mt-4">
            ...
            <div class="card-body">
                ...
                <div class="ms-auto">
                    ...
                    <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="2 New Messages">
                        <img alt="Image placeholder" src="/master/assets/img/team-1.jpg">
                    </a>
                    <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="1 New Message">
                        <img alt="Image placeholder" src="/master/assets/img/team-2.jpg">
                    </a>
                    <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="13 New Messages">
                        <img alt="Image placeholder" src="/master/assets/img/team-3.jpg">
                    </a>
                    <a href="javascript:;" class="avatar avatar-sm border-0 rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="7 New Messages">
                        <img alt="Image placeholder" src="/master/assets/img/team-4.jpg">
                    </a>
                    </div>
                </div>
                </div>
